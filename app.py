...
app.config['SQLALCHEMY_DATABASE_URI'] = 'sqlite:///' + os.path.join(basedir, 'agronexo_v15_pro.db')
...
class Lote(db.Model):
    ...
    geometria = db.Column(db.Text) # Almacena el área dibujada
...
def reset():
    ...
    return "AGRONEXO V15 - SISTEMA TOTAL REESTABLECIDO"
